      ...
      ((setf)
       (if (= (length args) 2)
           (let* ((place (car args))
             ...
             (cond
              ((symbol? place)
               (eval-setf-symbol-place place env val))
      ...
      ((incf)
       (if (or (= (length args) 1) (= (length args) 2))
           (let* ((place (car args))
             ...
             (cond
              ((symbol? place)
               (eval-incf-symbol-place place env delta))
              ((and (pair? place) (eq? (car place) 'car) (= (length place) 2))
