        ...
        (setq out
              (string-append
               ...
               (cond
                ...
                ((eq (inline-kind n) 'inline-math) (inline-math-text n))
                ((eq (inline-kind n) 'inline-raw) (inline-raw-text n))
                (t "")))))
      (setq rest (cdr rest)))
    out))
  ...
  (cond
   ...
   ((eq (inline-kind n) 'inline-abbr)
    (string-append "<abbr title=\"" (attr-escape (inline-abbr-title n)) "\">"
                   ...
                   "</abbr>"))
   ((eq (inline-kind n) 'inline-math)
    (if (inline-math-display n)
        (string-append "<span class=\"math display\">" (html-escape (inline-math-text n)) "</span>")
        (string-append "<span class=\"math\">" (html-escape (inline-math-text n)) "</span>")))
   ((eq (inline-kind n) 'inline-raw)
    (inline-raw-text n))
   (t "")))
...
(defun render-block (b)
  (cond
   ...
   ((eq (block-kind b) 'block-div)
    (render-div-block b))
   ((eq (block-kind b) 'block-math)
    (string-append "<div class=\"math display\">" (html-escape (block-math-text b)) "</div>"))
   ((eq (block-kind b) 'block-raw)
    (block-raw-text b))
